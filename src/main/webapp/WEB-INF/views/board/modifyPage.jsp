...
<div id="container">
	...
	<div class="bodytext_area box_inner">
		<form id="modifyForm" action="/board/modifyPage" method="post">
			<table border="1" style="width: 100%;">
				<tr>
					<td>제목</td>
					<td><input type="text" name="n_title" value="${noticeBoardVO.n_title}"  required="required"></td>
				</tr>
				
				<tr>
					<td>작성자</td>
					<td><input type="text" name="n_writer" value="${userInfo.uname}" readonly="readonly" required="required"></td>
				</tr>
				
				<tr>
					<td>내용</td>
					<td><textarea style="width: 100%;" name="n_content" id="n_content" rows="3">${noticeBoardVO.n_content}</textarea></td>
				</tr>
			</table>
