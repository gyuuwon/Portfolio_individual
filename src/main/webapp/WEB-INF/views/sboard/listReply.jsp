	...
	<div class="bodytext_area box_inner">
		<form action="#" class="minisrch_form">
			<fieldset>
				...
				<div class="searchBar">
					...
					<a href="/sboard/register" class="btn_srch" id="newBtn">글작성</a>
				</div>
				<!-- //searchBar -->
					...
					<c:when test="${board.showboard eq 'Y'}">
						<tr>
							...
							<td><a style="text-decoration: none;"
								href="/sboard/readPage${pageMaker.makeSearchQuery(pageMaker.cri.page)}&bno=${board.bno}">
		...
		<div class="pagination">
			<c:if test="${pageMaker.prev}">
				<a href="/sboard/listReply${pageMaker.makeSearchQuery(1)}" class="firstpage  pbtn"> 
					<img src="/resources/img/btn_firstpage.png" alt="첫 페이지로 이동">
				</a>
				<a href="/sboard/listReply${pageMaker.makeSearchQuery(pageMaker.startPage-1)}" class="prevpage  pbtn"> 
			...
			<c:forEach var="i" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
				...
				<c:choose>
					<c:when test="${pageMaker.cri.page == i}">
						<a href="/sboard/listReply${pageMaker.makeSearchQuery(i)}">
			...
			<c:if test="${pageMaker.next}">
				<a href="/sboard/listReply${pageMaker.makeSearchQuery(pageMaker.endPage+1)}" class="nextpage  pbtn"> 
					<img src="/resources/img/btn_nextpage.png" alt="다음 페이지로 이동">
				</a>
				<a href="/sboard/listReply${pageMaker.makeSearchQuery(pageMaker.maxPage)}" class="lastpage  pbtn"> 
